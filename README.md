![bina_image](https://github.com/user-attachments/assets/3b81922a-85d2-42fd-98df-ffa5eb804116)
# Bina Platform
...
## Installing Moodle 3.10 on Windows
...
## Installing Moodle 3.10 on a PHP Server
To install Moodle on a PHP server, you can use the following link: https://download.moodle.org/download.php/stable310/moodle-3.10.11.zip.     \
After extracting the compressed files and deploying them onto the desired server, the installation window will appear. The PHP server settings must be adjusted according to Moodle's requirements, which are displayed during the installation process.\
System Requirements for this Version:\
```PHP 7.2, MariaDB 10.2.29 or MySQL 5.7 or PostgreSQL 9.6 or MSSQL 2012 or Oracle 11.2```    \
Other versions of Moodle for PHP servers are available at the following addresses: https://download.moodle.org/releases/latest/ https://download.moodle.org/releases/legacy/.
